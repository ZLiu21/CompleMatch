...
from ts_data.preprocessing import normalize_uea_set, fill_nan_value, load_UEA
...
from utils.ts_utils import set_seed, get_all_datasets, \
...
dataset_para = {
    'EthanolConcentration': {'features_len': 221, 'features_len_freq': 112},
    'FaceDetection': {'features_len': 10, 'features_len_freq': 6},
    'MotorImagery': {'features_len': 377, 'features_len_freq': 190},
    'SelfRegulationSCP2': {'features_len': 146, 'features_len_freq': 74},
    'SpokenArabicDigits': {'features_len': 14, 'features_len_freq': 8}
}
...
if __name__ == '__main__':
    ...
    # Dataset setup
    parser.add_argument('--dataset', type=str, default='SpokenArabicDigits', help='dataset(in ucr)')  # GunPoint DiatomSizeReduction 
    parser.add_argument('--dataroot', type=str, default='./Multivariate2018_arff', help='path of UCR folder')
    ...
    parser.add_argument('--aug2_time_method_index', type=int, default=2, help='1,2,3,4,5,6')
    parser.add_argument('--aug_freq_method_index', type=int, default=1, help='1,2,3,4')
    parser.add_argument('--aug2_freq_method_index', type=int, default=4, help='1,2,3,4')
    ...
    args.seq_len = sum_dataset.shape[2]
    args.input_size = sum_dataset.shape[1]
    ...
    args.input_size = 2 * sum_dataset.shape[1]
    args.input_channels = args.input_size
    ...
    for i, train_dataset in enumerate(train_datasets):
        ...
        for _j in range(num_channels):
            ...
            train_fft_list.append(fft_converted)  
